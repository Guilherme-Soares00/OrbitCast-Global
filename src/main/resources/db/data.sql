...
ALTER TABLE clientes ALTER COLUMN id RESTART WITH 1000;
ALTER TABLE canais ALTER COLUMN id RESTART WITH 1000;
ALTER TABLE regioes ALTER COLUMN id RESTART WITH 1000;
ALTER TABLE campanhas_transmissao ALTER COLUMN id RESTART WITH 1000;
ALTER TABLE simulacoes ALTER COLUMN id RESTART WITH 1000;
ALTER TABLE planos_cobertura ALTER COLUMN id RESTART WITH 1000;
