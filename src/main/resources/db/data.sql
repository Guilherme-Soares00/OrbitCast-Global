INSERT INTO T_OC_CLIENTE (id_cliente, nome, documento, email, telefone, segmento, data_cadastro, ativo) VALUES
...
INSERT INTO T_OC_CANAL (id_canal, id_cliente, nome, tipo_conteudo, publico_alvo, classificacao_indicativa, ativo) VALUES
...
INSERT INTO T_OC_REGIAO (id_regiao, nome, estado, pais, populacao_estimada, indice_conectividade, latitude, longitude, area_km2, prioridade_social) VALUES
...
INSERT INTO T_OC_CAMPANHA (id_campanha, id_cliente, id_canal, nome, descricao, data_inicio, data_fim, duracao_horas, qualidade_desejada, orcamento, status) VALUES
...
INSERT INTO T_OC_CAMPANHA_REGIAO (id_campanha, id_regiao, prioridade, observacao) VALUES (1, 1, 5, 'Foco principal da campanha educacional.');
INSERT INTO T_OC_CAMPANHA_REGIAO (id_campanha, id_regiao, prioridade, observacao) VALUES (1, 2, 4, 'Alta demanda por conteudo educacional.');
INSERT INTO T_OC_CAMPANHA_REGIAO (id_campanha, id_regiao, prioridade, observacao) VALUES (1, 3, 5, 'Baixissima conectividade.');
INSERT INTO T_OC_CAMPANHA_REGIAO (id_campanha, id_regiao, prioridade, observacao) VALUES (2, 1, 5, 'Cobertura regional prioritaria.');
INSERT INTO T_OC_CAMPANHA_REGIAO (id_campanha, id_regiao, prioridade, observacao) VALUES (2, 2, 5, 'Amplo publico potencial.');
INSERT INTO T_OC_CAMPANHA_REGIAO (id_campanha, id_regiao, prioridade, observacao) VALUES (3, 4, 4, 'Interior com publico de eventos.');
INSERT INTO T_OC_CAMPANHA_REGIAO (id_campanha, id_regiao, prioridade, observacao) VALUES (3, 6, 3, 'Regiao de interesse cultural.');
INSERT INTO T_OC_CAMPANHA_REGIAO (id_campanha, id_regiao, prioridade, observacao) VALUES (3, 9, 4, 'Boa sinergia com evento regional.');
INSERT INTO T_OC_CAMPANHA_REGIAO (id_campanha, id_regiao, prioridade, observacao) VALUES (4, 5, 5, 'Area sensivel para comunicados preventivos.');
INSERT INTO T_OC_CAMPANHA_REGIAO (id_campanha, id_regiao, prioridade, observacao) VALUES (4, 8, 4, 'Historico de isolamento em eventos extremos.');
INSERT INTO T_OC_CAMPANHA_REGIAO (id_campanha, id_regiao, prioridade, observacao) VALUES (5, 6, 4, 'Regiao retratada no documentario.');
INSERT INTO T_OC_CAMPANHA_REGIAO (id_campanha, id_regiao, prioridade, observacao) VALUES (5, 10, 2, 'Publico cultural complementar.');
INSERT INTO T_OC_CAMPANHA_REGIAO (id_campanha, id_regiao, prioridade, observacao) VALUES (6, 1, 5, 'Comunidades ribeirinhas prioritarias.');
INSERT INTO T_OC_CAMPANHA_REGIAO (id_campanha, id_regiao, prioridade, observacao) VALUES (6, 2, 4, 'Abrangencia populacional relevante.');
INSERT INTO T_OC_CAMPANHA_REGIAO (id_campanha, id_regiao, prioridade, observacao) VALUES (6, 3, 5, 'Necessidade critica de comunicacao.');

INSERT INTO T_OC_SIMULACAO (id_simulacao, id_campanha, custo_estimado, alcance_estimado, qualidade_sinal, viabilidade, recomendacao, data_simulacao) VALUES
...
INSERT INTO T_OC_PLANO_COBERTURA (id_plano, id_campanha, nome, descricao, custo_total, alcance_total, viabilidade_geral) VALUES
...
ALTER TABLE T_OC_CLIENTE ALTER COLUMN id_cliente RESTART WITH 1000;
ALTER TABLE T_OC_CANAL ALTER COLUMN id_canal RESTART WITH 1000;
ALTER TABLE T_OC_REGIAO ALTER COLUMN id_regiao RESTART WITH 1000;
ALTER TABLE T_OC_CAMPANHA ALTER COLUMN id_campanha RESTART WITH 1000;
ALTER TABLE T_OC_SIMULACAO ALTER COLUMN id_simulacao RESTART WITH 1000;
ALTER TABLE T_OC_PLANO_COBERTURA ALTER COLUMN id_plano RESTART WITH 1000;
